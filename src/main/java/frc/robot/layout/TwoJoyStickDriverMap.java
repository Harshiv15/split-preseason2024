...
public class TwoJoyStickDriverMap extends DriverMap {
    ...
    public JoystickButton getResetOdometryButton() {return controller.getButton(Button.BUTTON_A);}

    // Driving logic is already implemented in the base class (DriverMap) using Drivetrain.java's superclass!
    @Override
